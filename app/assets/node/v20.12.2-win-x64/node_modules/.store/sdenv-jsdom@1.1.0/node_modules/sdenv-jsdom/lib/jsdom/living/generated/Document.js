...
exports.install = (globalObject, globalNames) => {
  ...
  class Document extends globalObject.Node {
    ...
    get cookie_() {
      ...
      if (!exports.is(esValue)) {
        throw new globalObject.TypeError("'get cookie_' called on an object that is not a valid instance of Document.");
      }

      return esValue[implSymbol]["cookie_"];
    }
    ...
    set cookie_(V) {
      ...
      if (!exports.is(esValue)) {
        throw new globalObject.TypeError("'set cookie_' called on an object that is not a valid instance of Document.");
      }

      V = conversions["USVString"](V, {
        context: "Failed to set the 'cookie_' property on 'Document': The provided value",
        globals: globalObject
      });

      esValue[implSymbol]["cookie_"] = V;
    }
